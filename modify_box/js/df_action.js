...
(function(){
  ...
  */
  ...
  dialog.show = function(set,fn){
    ...
    $("body").append("<div class='df_bgmask'></div><div class='df_dialog'><div class='df_dialg_title'>"+set_arr.title+"</div><div class='df_dialog_content'>"+set_arr.content+"</div><div class='df_dialog_button'></div></div>");
    switch(set_arr.type){
      case "alert":
